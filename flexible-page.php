...
if( class_exists('acf') ) { 
    if ( get_field('flex_full_width') ) {
        ...
        add_filter( 'body_class', 'mbird_add_body_class' );
        // Force full-width-content layout setting
        add_filter( 'genesis_pre_get_option_site_layout', '__genesis_return_full_width_content' );
        // Place Header with hero options and wrap
        add_action( 'genesis_entry_content', 'mbird_replace_header_with_wrap', 1 );
        // Place Flexible content
        add_action( 'genesis_entry_content', 'mbird_add_flexible_content', 1 );
        // Place content with wrap
        add_action( 'genesis_entry_content', 'mbird_replace_content_with_wrap', 1 );
    } else {
        // Place Header with hero options
        add_action( 'genesis_entry_content', 'mbird_replace_header', 1 );
        // Place Flexible content
        add_action( 'genesis_entry_content', 'mbird_add_flexible_content', 1 );
        // Place content
        add_action( 'genesis_entry_content', 'mbird_replace_content', 1 );
    }
} else {
    // Place content
    add_action( 'genesis_entry_content', 'mbird_replace_content', 1 );
...
function mbird_add_body_class( $classes ) {
	$classes[] = 'full';
	return $classes;
}

function mbird_place_yoast_breadcrumbs() {
...
function mbird_replace_header_with_wrap() {
...
function mbird_replace_content() {
...
function mbird_replace_content_with_wrap() {
...
function mbird_add_flexible_content() {
